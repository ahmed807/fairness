...
# Configure logging
logging.basicConfig(filename='LED_mixed_conservative_75_log.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
dataset = load_dataset("ahmed275/mixed_dataset_temporal_conservative_75")

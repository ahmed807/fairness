...
logging.basicConfig(filename='Longformer_syllabus_log.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
api = HfApi()
repo_id = "ahmed275/SS-Longformer_syllabus"
